...
export const studioApps: StudioApp[] = [
  ...
  {slug:"geldinzicht", name:"GeldInzicht", eyebrow:"MEER RUST IN JE GELD", description:"Krijg een helder overzicht van inkomsten, uitgaven en spaardoelen, zonder ingewikkeld financieel jargon.", image:"/afbeeldingen/geldinzichtNew/home.png", screenshots:["/afbeeldingen/geldinzichtNew/overview.png","/afbeeldingen/geldinzichtNew/transactions.png","/afbeeldingen/geldinzichtNew/budget.png","/afbeeldingen/geldinzichtNew/accounts.png","/afbeeldingen/geldinzichtNew/savings.png","/afbeeldingen/geldinzichtNew/settings.png"], features:["Rekeningen en transacties","Duidelijke categorieën","Persoonlijke spaardoelen"]},
